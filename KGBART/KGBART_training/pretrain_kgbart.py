...
def main():
    ...
    parser.add_argument('--train_pretraining_num', type = int, default=20,
                        help="The number of sample training pretraining KG. ")
    parser.add_argument('--val_pretraining_num', type = int, default=20,
    ...
    bi_uni_pipeline = [
        seq2seq_loader.Preprocess4Pretrain(list(tokenizer.encoder.keys()), tokenizer.convert_tokens_to_ids,
    ...
    if args.do_train:
        ...
        if args.pretraining_KG:
            file_oracle = os.path.join(args.data_dir, 'CommonGen_KG/commongen_entity2id.txt')
        fn_src = os.path.join(
        ...
        train_dataset = seq2seq_loader.Seq2SeqDataset(
            ...
            args.max_seq_length, pretraining_KG=file_oracle, pretraining_num = args.train_pretraining_num, bi_uni_pipeline=bi_uni_pipeline)
    ...
    if args.do_eval:
        ...
        dev_dataset = seq2seq_loader.Seq2SeqDataset(
            ...
            args.max_seq_length, pretraining_KG=file_oracle, pretraining_num = args.val_pretraining_num,
